...
a) ADRESS_MUMBLE_SERVER= Change the port of mumble (by default : 64738)

b) PORT_MUMBLE_SERVER= Change Password of your superuser

c) SERVER_PASSWORD= Change Address for your server Mumble
